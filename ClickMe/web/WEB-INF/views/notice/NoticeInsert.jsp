...
<body>
	...
	<h2>공지사항 등록 폼</h2>
	<form action="${pageContext.servletContext.contextPath}/list/insert" method="post" style="display: inline-block">
		<fieldset>
			...
			<input type="text" name="title" size="50" placeholder="공지사항 제목을 입력해주세요."/><br>
			<label>3. 공지사항 내용</label>
			<textarea name="content" rows="10" cols="50" placeholder="공지사항 내용을 작성해 주세요." style="resize: vertical;"></textarea><br>
			<br>
