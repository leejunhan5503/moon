...
public class UserSelectCriteria implements java.io.Serializable {
	...
	public UserSelectCriteria() {}

	public UserSelectCriteria(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage,
